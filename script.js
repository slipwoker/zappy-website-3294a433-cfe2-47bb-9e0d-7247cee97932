document.addEventListener('DOMContentLoaded', function () {
  ...
  function clearFieldError(field) {
    ...
    var existingError = field.parentNode.querySelector('.form-error-message');
    if (existingError) {
  ...
  if (animatedElements.length === 0) {
    var autoTargets = document.querySelectorAll(
      '.section, section, .card, .feature, .testimonial, .hero-content, .cta-block'
    );
  ...
  function applyAnimationStyles() {
    if (!document.getElementById('scroll-animation-styles')) {
      ...
      style.textContent = [
        ...
        '}',
        '.animate-on-scroll.is-visible, .fade-in.is-visible, [data-animate].is-visible {',
        '  opacity: 1;',
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '3294a433-cfe2-47bb-9e0d-7247cee97932',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '3294a433-cfe2-47bb-9e0d-7247cee97932';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '3294a433-cfe2-47bb-9e0d-7247cee97932';
